...
abstract class GenericRepository {
    ...
    private constructor (schema: Model<Document>) {
    ...
    public async findByIdAndUpdate (id: string, query: {}, actionsJson: {}) {
        return await this.mongooseSchema.findByIdAndUpdate(id, query, actionsJson);
    }
